...
public class ModuleManager {
  ...
  @Nonnull
  public final <T extends AbstractModule> T
    ...
    throw new IllegalArgumentException(
        "Module name is not found : " + className);
  }
  ...
  private AbstractModule getModule(@Nonnull Class<AbstractModule> moduleClass) {
    try {
      Constructor<AbstractModule> constructor = moduleClass.getConstructor(
  ...
  private ExtAction getExtAction(Class<ExtAction> actionClass) {
    try {
      Constructor<ExtAction> constructor = actionClass.getConstructor(
          AgentInfo.class, WorldInfo.class, ScenarioInfo.class,
          ModuleManager.class, DevelopData.class);
  ...
  @SuppressWarnings("unchecked")
  @Nonnull
  public final <E extends CommandExecutor<? extends CommunicationMessage>> E
    ...
    try {
      ...
      if (CommandExecutor.class.isAssignableFrom(actionClass)) {
        instance = this.getCommandExecutor(
            (Class<CommandExecutor<CommunicationMessage>>) actionClass);
  ...
  @SuppressWarnings("unchecked")
  @Nonnull
  private <E extends CommandExecutor<? extends CommunicationMessage>> E
      getCommandExecutor(Class<E> actionClass) {
    try {
      Constructor<E> constructor = actionClass.getConstructor(AgentInfo.class,
      ...
      this.executorMap.put(actionClass.getCanonicalName(),
          (CommandExecutor<CommunicationMessage>) instance);
      return instance;
    } catch (NoSuchMethodException | InstantiationException
        | IllegalAccessException | InvocationTargetException e) {
      throw new RuntimeException(e);
  ...
  private CommandPicker getCommandPicker(Class<CommandPicker> actionClass) {
    try {
      Constructor<CommandPicker> constructor = actionClass.getConstructor(
          AgentInfo.class, WorldInfo.class, ScenarioInfo.class,
          ModuleManager.class, DevelopData.class);
  ...
  public final ChannelSubscriber getChannelSubscriber(String subscriberName,
    ...
    try {
      ...
      if (ChannelSubscriber.class.isAssignableFrom(actionClass)) {
        instance = this
            .getChannelSubscriber((Class<ChannelSubscriber>) actionClass);
  ...
  public final ChannelSubscriber
      getChannelSubscriber(Class<ChannelSubscriber> subsClass) {
    try {
  ...
  public final MessageCoordinator getMessageCoordinator(String coordinatorName,
    ...
    try {
      ...
      if (MessageCoordinator.class.isAssignableFrom(actionClass)) {
        instance = this
            .getMessageCoordinator((Class<MessageCoordinator>) actionClass);
  ...
  public final MessageCoordinator
      getMessageCoordinator(Class<MessageCoordinator> subsClass) {
    try {
